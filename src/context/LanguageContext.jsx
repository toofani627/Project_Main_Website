...
const translations = {
  en: {
    ...
    phosphorus: 'Phosphorus (Estimated)',
    potassium: 'Potassium (Estimated)',
    phLevel: 'pH Level (Estimated)',
    electricalConductivity: 'EC (Estimated)',
    light: 'Light',
    gps: 'GPS',
    timestamp: 'Timestamp',
  ...
  hi: {
    ...
    nitrogen: 'नाइट्रोजन (अनुमानित)',
    phosphorus: 'फॉस्फोरस (अनुमानित)',
    potassium: 'पोटैशियम (अनुमानित)',
    phLevel: 'pH स्तर (अनुमानित)',
    electricalConductivity: 'EC (अनुमानित)',
    light: 'रोशनी',
    gps: 'लोकेशन',
    timestamp: 'समय',
  ...
  ta: {
    ...
    nitrogen: 'நைட்ரஜன் (மதிப்பீடு)',
    phosphorus: 'பாஸ்பரஸ் (மதிப்பீடு)',
    potassium: 'பொட்டாசியம் (மதிப்பீடு)',
    phLevel: 'pH நிலை (மதிப்பீடு)',
    electricalConductivity: 'EC (மதிப்பீடு)',
    light: 'ஒளி',
    gps: 'இடம்',
    timestamp: 'நேரம்',
    ...
    mockedData: 'மதிப்பிடப்பட்ட தரவு',
    weather: 'வானிலை',
    today: 'இன்று',
    tomorrow: 'நாளை',
    ...
    deviceTitle: 'சாதனம்',
    reading: 'படிக்கிறது...',
    demoDataBtn: 'செயற்கைக்கோள் ஸ்கேன்',
